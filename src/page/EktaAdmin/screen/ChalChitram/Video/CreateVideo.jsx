        ...
        <Grid container spacing={0}>
          <Grid item xs={12}>
            <div style={{ display: "flex" }}>
              ...
              >
                <Button variant="success" onClick={()=>navigate(`/EktaAdmin/VideoList`)}>
                  <ArrowBackIcon />
                  Back
                </Button>
              </div>
          ...
          <Grid item xs={6}>
            <Form style={{ paddingLeft: "50px", paddingRight: "50px" }}>
              ...
              >
                ...
                <Form.Control
                  ...
                  onChange={(e) =>{ setvideo_url(e.target.value)
                    ...
                    setVideoImage(`https://img.youtube.com/vi/${result}/sddefault.jpg`);
              ...
              <label for="cars">SelectCategory</label>
              <select
                id="cars"
                name="carlist"
                className="form-control"
                onChange={(e)=>setvideo_category(e.target.value)}
                form="carform"
              >
                {keywords.map((data) => (
                  <>
                    <option value={data.enum}>{data.value}</option>
                  </>
                ))}
