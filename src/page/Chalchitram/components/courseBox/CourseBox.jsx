...
const CourseBox = ({videoData}) => {
  ...
  return (
    <div
      ...
      onClick={() => navigate(`/ChalChitram/CourseHomeScreen/${videoData?.id}`)}
    >
      <div className="video__top">
        <LazyLoadImage src={`https://ekta-ej-laksh-image.s3.us-east-2.amazonaws.com/${videoData?.course_image}`} effect="blur" style={{borderRadius:"15% 0 ",border:"2px solid white"}} />
