...
import { getAllVideoesAction, getCourseVideoesAction, getHistoryVideoesAction } from "../../../../Redux/Actions";
...
const HistoryHomeScreen = () => {
  ...
  useEffect(() => {
    dispatch(getHistoryVideoesAction(courseId,pagenumber, 10));
  }, []);
  ...
  return (
    <Container>
      ...
      {/* <InfiniteScroll
        ...
        {/* className="row" */}
      {/* > */} 
        {chalchitram&&chalchitram?.getHistoryVideo?.rows &&
          chalchitram?.getHistoryVideo?.rows[0]?.ektaVideos.map((videoData) => (
            <Col lg={3} md={4}>
