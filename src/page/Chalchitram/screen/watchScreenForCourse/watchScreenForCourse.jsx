...
import { getCourseVideoByIdAPI, getVideoByIdAPI } from "../../../../api/index";

import { useDispatch, useSelector } from "react-redux";

const WatchScreenForCourse = () => {
  ...
  const fatchVideo = async () => {
    try {
      setIsLoading(true);
      const res = await getCourseVideoByIdAPI(
...
export default WatchScreenForCourse;
